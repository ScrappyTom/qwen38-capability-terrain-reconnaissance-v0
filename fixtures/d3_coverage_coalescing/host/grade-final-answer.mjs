...
const result = {
  schema_version: 1,
  grader: "experiment-102-final-answer-contract",
  exact_declared_labels: labels,
  minimum_section_characters: 20,
  minimum_total_characters: 180,
  sections,
  total_characters: answer.trim().length,
  passed: sections.every((section) => section.present && section.ordered && section.substantive) && answer.trim().length >= 180
};
